		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				...
				<div class="comment-content">
					<?php comment_text(); ?>
					<?php if($comment->user_id == 5){ echo '<span class="admin_author" style="position:relative; background-color:red;">来自'.sprintf( '<b class="fn">%s</b>', get_comment_author_link( $comment ) ).'的点评</span>'; } ?>
				</div><!-- .comment-content -->
